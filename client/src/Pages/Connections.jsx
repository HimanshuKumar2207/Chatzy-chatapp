        ...
        <div className="max-w-6xl mx-auto p-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-600">
              Manage you network and discover new connections
            </p>
          </div>
          {/* counts */}
          ...
          <div className="mb-8 flex flex-wrap gap-6">
            {dataArray.map((item, index) => (
              <div
                key={index}
                className="flex flex-col items-center justify-center gap-1 border h-20 w-20 border-gray-200 bg-white shadow rounded-md"
              >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex max-sm:flex-col gap-2 mt-4">
                      ...
                      {currentTab === "Connections" && (
                        <button
                          onClick={() => navigate("/messages/${user_.id}")}
