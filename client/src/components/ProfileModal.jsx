...
const ProfileModal = ({ setShowEdit }) => {
  ...
  return (
    <>
      <div className="fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-scroll bg-black/50">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <form className="space-y-4" onSubmit={handleSaveProfile}>
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full p-3 border borderr-gray-200 rounded-lg"
              ...
              <div className="flex justify-end space-x-3 pt-6">
                <button
                  ...
                  type="button"
                  className="px-4
                 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointers"
                >
                  Cancel
                </button>
                <button
